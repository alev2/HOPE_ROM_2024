...
newDir3=Vk*(Sk\Uk')*((UApx'*(stdMat\([200000;  35000; 22000; 22000;279000;1100] - rowMeans(:,1)) )));
newDir4=Vk*(Sk\Uk')*((UApx'*(stdMat\([200000;  35000; 22000; 22000;279000;900] - rowMeans(:,1)) )));
newDir5=Vk*(Sk\Uk')*((UApx'*(stdMat\([150000;  30000; 20000; 20000;220000;1250] - rowMeans(:,1)) )));
newDir6=Vk*(Sk\Uk')*((UApx'*(stdMat\([150000;  30000; 20000; 20000;220000;1150] - rowMeans(:,1)) )));

%newDir3=Vk*(Sk\Uk')*((UApx'*(stdMat\([120000; 18000; 10000; 10000;158000;490] - rowMeans(:,1)) )));
%newDir6=Vk*(Sk\Uk')*((UApx'*(stdMat\([120000; 18000; 10000; 10000;158000;450] - rowMeans(:,1)) )));

evalDomain=[evalDomain_Base' evalDomain_Base2' evalDomain_Base'+newDir evalDomain_Base'+newDir2 evalDomain_Base'+newDir3 evalDomain_Base'+newDir4 evalDomain_Base'+newDir5 evalDomain_Base'+newDir6 ];
...
UApx*(output_Of_Interest-output_Of_Interest(:,1))
