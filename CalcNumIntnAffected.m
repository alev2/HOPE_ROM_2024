...
%   Continuous version: called from StepStateCont
    ...
    % Pre-allocate testing and diag rate vars (warning shows up when this
    % is inside section "loop"
    DiseaseStageTestRate(1:Params.numHIVstages) = 0;
    DiseaseStageDiagRate(1:Params.numHIVstages) = 0;
    ...
    % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
       ...
       tsLatentTestRate = tstep * TTProg.LatentTestRate;
   ...
   % Calculate number of tests
        ...
        %Positive tests (updated by KH for V 10.06 on 24Jan2024)
        %  Rapid
        TTProg.numTSPosRapidTests_byHIVStage(:,2) = ...
            TTProg.PctTestsRapid .* (TestSens_Rapid_Acute .* (Compartments(Params.B1,:)' .* tsAcuteTestRate));
        TTProg.numTSPosRapidTests_byHIVStage(:,3) = ...
            TTProg.PctTestsRapid .* (TestSens_Rapid_Chronic .* (Compartments(Params.C1,:)' .* tsLatentTestRate));
        TTProg.numTSPosRapidTests_byHIVStage(:,4) = ...
            TTProg.PctTestsRapid .* (TestSens_Rapid_Chronic .* (Compartments(Params.D1,:)' .* tsLateTestRate));
        TTProg.numTSPosRapidTests_byHIVStage(:,5) = ...
            TTProg.PctTestsRapid .* (TestSens_Rapid_Chronic .* (Compartments(Params.E1,:)' .* tsAIDSTestRate));
        %  Conventional
        TTProg.numTSPosConvTests_byHIVStage(:,2)= ...
            (1-TTProg.PctTestsRapid) .* (TestSens_Conv_Acute .* (Compartments(Params.B1,:)' .* tsAcuteTestRate));
        TTProg.numTSPosConvTests_byHIVStage(:,3) = ...
            (1-TTProg.PctTestsRapid) .* (TestSens_Conv_Chronic .* (Compartments(Params.C1,:)' .* tsLatentTestRate));
        TTProg.numTSPosConvTests_byHIVStage(:,4) = ...
            (1-TTProg.PctTestsRapid) .* (TestSens_Conv_Chronic .* (Compartments(Params.D1,:)' .* tsLateTestRate));
        TTProg.numTSPosConvTests_byHIVStage(:,5) = ...
            (1-TTProg.PctTestsRapid) .* (TestSens_Conv_Chronic .* (Compartments(Params.E1,:)' .* tsAIDSTestRate));

        %Negative tests (code above replaced by this code by KH on 24Jan2024)
        %  Rapid
        TTProg.numTSNegRapidTests_byHIVStage(:,1) = ...
            TTProg.PctTestsRapid .* (Compartments(Params.A1,:)' .* tsUninfectedTestRate);
        TTProg.numTSNegRapidTests_byHIVStage(:,2) = ...
            TTProg.PctTestsRapid .* ((1 - TestSens_Rapid_Acute) .* (Compartments(Params.B1,:)' .* tsAcuteTestRate));
        TTProg.numTSNegRapidTests_byHIVStage(:,3) = ...
            TTProg.PctTestsRapid .* ((1 - TestSens_Rapid_Chronic) .* (Compartments(Params.C1,:)' .* tsLatentTestRate));
        TTProg.numTSNegRapidTests_byHIVStage(:,4) = ...
            TTProg.PctTestsRapid .* ((1 - TestSens_Rapid_Chronic) .* (Compartments(Params.D1,:)' .* tsLateTestRate));
        TTProg.numTSNegRapidTests_byHIVStage(:,5) = ...
            TTProg.PctTestsRapid .* ((1 - TestSens_Rapid_Chronic) .* (Compartments(Params.E1,:)' .* tsAIDSTestRate));
        %  Conventional
        TTProg.numTSNegConvTests_byHIVStage(:,1) = ...
            (1 - TTProg.PctTestsRapid) .* (Compartments(Params.A1,:)' .* tsUninfectedTestRate);
        TTProg.numTSNegConvTests_byHIVStage(:,2) = ...
            (1-TTProg.PctTestsRapid) .* ((1 - TestSens_Conv_Acute) .* (Compartments(Params.B1,:)' .* tsAcuteTestRate));
        TTProg.numTSNegConvTests_byHIVStage(:,3) = ...
            (1-TTProg.PctTestsRapid) .* ((1 - TestSens_Conv_Chronic) .* (Compartments(Params.C1,:)' .* tsLatentTestRate));
        TTProg.numTSNegConvTests_byHIVStage(:,4) = ...
            (1-TTProg.PctTestsRapid) .* ((1 - TestSens_Conv_Chronic) .* (Compartments(Params.D1,:)' .* tsLateTestRate));
        TTProg.numTSNegConvTests_byHIVStage(:,5) = ...
            (1-TTProg.PctTestsRapid) .* ((1 - TestSens_Conv_Chronic) .* (Compartments(Params.E1,:)' .* tsAIDSTestRate));

        % Number of people notified (updated by KH for V 10.06 on 24Jan2024)

        TTProg.numTSConvPosNotify = ...
            sum(TTProg.numTSPosConvTests_byHIVStage,2) .* TTProg.NotifyPosConvProb;
        TTProg.numTSConvNegNotify = ...
            sum(TTProg.numTSNegConvTests_byHIVStage,2) .* TTProg.NotifyNegConvProb;
        TTProg.numTSRapidPosNotify = ...
            sum(TTProg.numTSPosRapidTests_byHIVStage,2) .* TTProg.NotifyPosRapidProb;
        TTProg.numTSRapidNegNotify = ...
            sum(TTProg.numTSNegRapidTests_byHIVStage,2) .* TTProg.NotifyNegRapidProb;
   ...
   % Calculation of status quo testing rates  
       ...
       if ((j == 1) && (YrIndex >0))  % first timestep of year and only during outcome collection period
            ...
            % Setting up compartment groupings
                ...
                HIVPosTestEligComparts = [Params.B1,Params.C1,Params.D1,Params.E1];
            
                % HIV+ and HIV - who are eligible to be tested
                TestEligComparts = [Params.A1,Params.B1,Params.C1,Params.D1,Params.E1];
            ...
            % Calculation of population sizes by cohort
                ...
                % Pull rates out of struct
                   ...
                   LatentTestRate = TTProg.LatentTestRate;
            ...
            % Annual Diagnosis Rates (by disease stage)
                ...
                LatentDiagRate = LatentTestRate .* TTProg.WtdSensAndNotify_Chronic;
            ...
            % Weighted rates for each cohort
                ...
                % Test rate by cohort for HIV+ and HIV-
                    ...
                    WeightedTestRateAllEligByCohort = ...
                        ...
                        LatentTestRate' .* Compartments(Params.C1,:) + ...
                        LateTestRate' .* Compartments(Params.D1,:) + ...
                        AIDSTestRate' .* Compartments(Params.E1,:))...
                ...
                % Diagnosis rate by cohort (HIV+)
                    ...
                    WeightedDiagRateGivenHIVPos = ...
                        ...
                        LatentDiagRate' .* Compartments(Params.C1,:) + ...
                        LateDiagRate' .* Compartments(Params.D1,:) + ...
                        AIDSDiagRate' .* Compartments(Params.E1,:))...
                        ./TestEligHIVPosPopByCohort;

            % Overall rates by race/ethnicities
                RaceSpecificAllEligTestRate(1:Params.numRace) = 0;
                RaceSpecificHIVPosTestRate(1:Params.numRace) = 0;
                RaceSpecificDiagRate(1:Params.numRace) = 0;
            ...
            % Risk group
                RiskGroupAllEligTestRate(1:Params.numPop) = 0;
                RiskGroupHIVPosTestRate(1:Params.numPop) = 0;
                RiskGroupDiagRate(1:Params.numPop) = 0;
            ...
            % Disease stage and uninfected rates
                % Testing
                    ...
                    DiseaseStageTestRate(Params.stage_Latent) = ...
                        sum(LatentTestRate' .* Compartments(Params.C1,:)) /...
                        sum(Compartments(Params.C1,:)); 
                    DiseaseStageTestRate(Params.stage_Late) = ...
                        sum(LateTestRate' .* Compartments(Params.D1,:)) /...
                        sum(Compartments(Params.D1,:)); 
                    DiseaseStageTestRate(Params.stage_AIDS) = ...
                        sum(AIDSTestRate' .* Compartments(Params.E1,:)) /...
                ...
                % Diagnosis
                    DiseaseStageDiagRate(Params.stage_Acute) = ...
                        ...
                        sum(Compartments(Params.B1,:));
                    DiseaseStageDiagRate(Params.stage_Latent) = ...
                        sum(LatentDiagRate' .* Compartments(Params.C1,:)) /...
                        sum(Compartments(Params.C1,:)); 
                    DiseaseStageDiagRate(Params.stage_Late) = ...
                        sum(LateDiagRate' .* Compartments(Params.D1,:)) /...
                        sum(Compartments(Params.D1,:)); 
                    DiseaseStageDiagRate(Params.stage_AIDS) = ...
                        sum(AIDSDiagRate' .* Compartments(Params.E1,:)) /...
                        sum(Compartments(Params.E1,:));                 
...
%             LinkageAfterRate_Latent = TTProg.LinkageAfterRate_Latent;
...
%             % after first)
%             AwareNotLTCComparts = [Params.B2,Params.C2,Params.D2,Params.E2];
