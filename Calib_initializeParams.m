...
% Test rates and relative risks
       ...
       % Reference cases: Black, HET, CD4 > 500
        ...
        % Period 1 relative risks (edited by JC on 11/13/2017; Revised by KH to collapse 350-500 and >500)
        ...
        % Period 2 relative risks (edited by JC on 11/13/2017; Revised by KH to collapse 350-500 and >500)
...
% Other Continuum of care parameters
    ...
    % Relative risk of LTC After, by disease stage        
        ...
        CalibParams.tt_RelRiskLTC_1_D.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
        CalibParams.tt_RelRiskLTC_1_E.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
        CalibParams.tt_RelRiskLTC_2to4_D.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
...
% Disease progression
        ...
        % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
        CalibParams.hiv_durStage_ANV_Latent_1344.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
        CalibParams.hiv_durStage_ANV_Latent_4564.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
        CalibParams.hiv_durStage_ANV_Latent_65.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
        ...
        % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
       CalibParams.hiv_rateVLSCD4decr_Latent.baseValue = ExcelValues_CalibParams(importIndex);
            importIndex = importIndex + 1;
