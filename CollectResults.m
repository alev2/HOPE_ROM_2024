...
%% 3. Define reference indices (to be used to collect data from the appropriate compartments)
    ...
    % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
    Comparts_CCStage1 = Params.UnawareComparts;
    Comparts_CCStage2 = [Params.B2, Params.C2, Params.D2,Params.E2];
    Comparts_CCStages23456 = Params.AwareComparts;
    Comparts_CCStages3456 = Params.CCStages3456;
    Comparts_CCStage3 = [Params.B3,Params.C3,Params.D3,Params.E3];
    Comparts_CCStage4 = Params.ANVComparts;
    Comparts_CCStages45 = Params.ANVandVLSComparts;
    Comparts_CCStage5 = Params.OralARTVLSComparts;
    Comparts_CCStage56 = Params.VLSComparts;
    Comparts_CCStage6 = Params.LAIARTVLSComparts;
    ...
    LatentComparts = Params.LatentComparts;
...
%% 4. Collect Model Settings and Preallocate Variables
    ...
    if t == 1 % first timestep or first year of outcomes collection
        ...
        if LastOutcomeYr >= Results.set_PeriodFiveStartYear
            Results.annCostT1andReachLvlRate_Test_LowRiskHETs_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_Test_HighRiskHETs_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_Test_LowRiskMSM_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_Test_HighRiskMSM_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_Test_IDU_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlProb_LTCatDiag_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;               
            Results.annCostT1andReachLvlRate_LTCafterDiag_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;                                              
            Results.annCostT1andReachLvlRate_ARTInit_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;                
            Results.annCostT1andReachLvlRate_ARTAdhere_BecomeVLS_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;                
            Results.annCostT1andReachLvlRate_ARTAdhere_RemainVLS_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlPctServed_SEP_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls)  = 0;
            Results.annCostT1andReachLvlPctServed_SEP_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls)  = 0;
            Results.annCostT1andReachLvlPctServed_SEP_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls)  = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETM_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETM_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETM_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETF_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETF_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_HETF_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_MSM_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_MSM_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_MSM_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_IDU_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_IDU_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Oral_IDU_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETM_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETM_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETM_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETF_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETF_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_HETF_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_MSM_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_MSM_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_MSM_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_IDU_B_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_IDU_H_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;
            Results.annCostT1andReachLvlRate_PrEP_Inject_IDU_O_inM(Results.set_ModelEndYear - Results.set_PeriodFiveStartYear + 1,Params.numIntnCostLvls) = 0;            
        end
       % Pre-allocate
...
% TRANSITIONS/COUNTS: Infection-related outcomes  
    ...
    % outcomes from new PrEP states
        ...
        Results.ts_NewInfections_A10(t,:) = Transitions(Params.A10,Params.B3,:, odeCounter);
        
        Results.ts_NewInfections_OnPrEP(t,:) = Results.ts_NewInfections_A7(t,:) + Results.ts_NewInfections_A8(t,:) + Results.ts_NewInfections_A9(t,:) + Results.ts_NewInfections_A10(t,:);
        
        Results.ts_TotalNewInfections(t,:) = Results.ts_NewInfections_A1(t,:) + Results.ts_NewInfections_A7(t,:) + Results.ts_NewInfections_A8(t,:) + Results.ts_NewInfections_A9(t,:) + Results.ts_NewInfections_A10(t,:);
    ...
    % New infections, by force of infection
        ...
        % Oral PrEP, high adherence
            Results.ts_NewInfectionsVonly_OnPrEP_Oral_High(t,:) = Results.ts_NewInfections_A7(t,:) .* InfRate_PrEP_Oral_High.RelativeInfRates(:,Params.force_Vonly,odeCounter)';
            Results.ts_NewInfectionsAonly_OnPrEP_Oral_High(t,:) = Results.ts_NewInfections_A7(t,:) .* InfRate_PrEP_Oral_High.RelativeInfRates(:,Params.force_Aonly,odeCounter)';
            Results.ts_NewInfectionsVsomeAI_OnPrEP_Oral_High(t,:) = Results.ts_NewInfections_A7(t,:) .* InfRate_PrEP_Oral_High.RelativeInfRates(:,Params.force_VsomeA,odeCounter)';
            Results.ts_NewInfectionsAsomeVI_OnPrEP_Oral_High(t,:) = Results.ts_NewInfections_A7(t,:) .* InfRate_PrEP_Oral_High.RelativeInfRates(:,Params.force_AsomeV,odeCounter)';
            Results.ts_NewInfectionsN_OnPrEP_Oral_High(t,:) = Results.ts_NewInfections_A7(t,:) .* InfRate_PrEP_Oral_High.RelativeInfRates(:,Params.force_N,odeCounter)';
        
        % Oral PrEP, Low adherence
            Results.ts_NewInfectionsVonly_OnPrEP_Oral_Low(t,:) = Results.ts_NewInfections_A8(t,:) .* InfRate_PrEP_Oral_Low.RelativeInfRates(:,Params.force_Vonly,odeCounter)';
            Results.ts_NewInfectionsAonly_OnPrEP_Oral_Low(t,:) = Results.ts_NewInfections_A8(t,:) .* InfRate_PrEP_Oral_Low.RelativeInfRates(:,Params.force_Aonly,odeCounter)';
            Results.ts_NewInfectionsVsomeAI_OnPrEP_Oral_Low(t,:) = Results.ts_NewInfections_A8(t,:) .* InfRate_PrEP_Oral_Low.RelativeInfRates(:,Params.force_VsomeA,odeCounter)';
            Results.ts_NewInfectionsAsomeVI_OnPrEP_Oral_Low(t,:) = Results.ts_NewInfections_A8(t,:) .* InfRate_PrEP_Oral_Low.RelativeInfRates(:,Params.force_AsomeV,odeCounter)';
            Results.ts_NewInfectionsN_OnPrEP_Oral_Low(t,:) = Results.ts_NewInfections_A8(t,:) .* InfRate_PrEP_Oral_Low.RelativeInfRates(:,Params.force_N,odeCounter)';    
            
        % Injectable PrEP, high adherence
            Results.ts_NewInfectionsVonly_OnPrEP_Inject_High(t,:) = Results.ts_NewInfections_A9(t,:) .* InfRate_PrEP_Inject_High.RelativeInfRates(:,Params.force_Vonly,odeCounter)';
            Results.ts_NewInfectionsAonly_OnPrEP_Inject_High(t,:) = Results.ts_NewInfections_A9(t,:) .* InfRate_PrEP_Inject_High.RelativeInfRates(:,Params.force_Aonly,odeCounter)';
            Results.ts_NewInfectionsVsomeAI_OnPrEP_Inject_High(t,:) = Results.ts_NewInfections_A9(t,:) .* InfRate_PrEP_Inject_High.RelativeInfRates(:,Params.force_VsomeA,odeCounter)';
            Results.ts_NewInfectionsAsomeVI_OnPrEP_Inject_High(t,:) = Results.ts_NewInfections_A9(t,:) .* InfRate_PrEP_Inject_High.RelativeInfRates(:,Params.force_AsomeV,odeCounter)';
            Results.ts_NewInfectionsN_OnPrEP_Inject_High(t,:) = Results.ts_NewInfections_A9(t,:) .* InfRate_PrEP_Inject_High.RelativeInfRates(:,Params.force_N,odeCounter)';
        
        % Injectable PrEP, Low adherence
            Results.ts_NewInfectionsVonly_OnPrEP_Inject_Low(t,:) = Results.ts_NewInfections_A10(t,:) .* InfRate_PrEP_Inject_Low.RelativeInfRates(:,Params.force_Vonly,odeCounter)';
            Results.ts_NewInfectionsAonly_OnPrEP_Inject_Low(t,:) = Results.ts_NewInfections_A10(t,:) .* InfRate_PrEP_Inject_Low.RelativeInfRates(:,Params.force_Aonly,odeCounter)';
            Results.ts_NewInfectionsVsomeAI_OnPrEP_Inject_Low(t,:) = Results.ts_NewInfections_A10(t,:) .* InfRate_PrEP_Inject_Low.RelativeInfRates(:,Params.force_VsomeA,odeCounter)';
            Results.ts_NewInfectionsAsomeVI_OnPrEP_Inject_Low(t,:) = Results.ts_NewInfections_A10(t,:) .* InfRate_PrEP_Inject_Low.RelativeInfRates(:,Params.force_AsomeV,odeCounter)';
            Results.ts_NewInfectionsN_OnPrEP_Inject_Low(t,:) = Results.ts_NewInfections_A10(t,:) .* InfRate_PrEP_Inject_Low.RelativeInfRates(:,Params.force_N,odeCounter)';    
...
% TRANSITIONS/COUNTS: Test and treat progression outcomes
    ...
    % Drop out
        ...
        % [LAI ART, VLS] -> [LTC]
            Results.ts_DropOff_LAIARTToLTC_C6(t,:) = Transitions(Params.C6,Params.C3,:, odeCounter);
            Results.ts_DropOff_LAIARTToLTC_D6(t,:) = Transitions(Params.D6,Params.D3,:, odeCounter);
            Results.ts_DropOff_LAIARTToLTC_E6(t,:) = Transitions(Params.E6,Params.E3,:, odeCounter);    
        ...
        % [PrEP] -> [Sus-no-PrEP]
            ...
            Results.ts_DropOff_PrEP_A10(t,:) = Transitions(Params.A10,Params.A1,:, odeCounter);
            
            Results.ts_DropOff_PrEP(t,:) = Results.ts_DropOff_PrEP_A7(t,:) + Results.ts_DropOff_PrEP_A8(t,:) + Results.ts_DropOff_PrEP_A9(t,:) + Results.ts_DropOff_PrEP_A10(t,:);
            Results.ts_DropOff_PrEP_Oral(t,:) = Results.ts_DropOff_PrEP_A7(t,:) + Results.ts_DropOff_PrEP_A8(t,:);
            Results.ts_DropOff_PrEP_Inject(t,:) = Results.ts_DropOff_PrEP_A9(t,:) + Results.ts_DropOff_PrEP_A10(t,:);
            
    % Initiate ART
    
        % Oral ART, Don't become VLS
        ...
        Results.ts_StartLAIART_fromLTC_B3(t,:) = Transitions(Params.B3,Params.C6,:, odeCounter);
        Results.ts_StartLAIART_fromLTC_C3(t,:) = Transitions(Params.C3,Params.C6,:, odeCounter);
        Results.ts_StartLAIART_fromLTC_D3(t,:) = Transitions(Params.D3,Params.D6,:, odeCounter);
        Results.ts_StartLAIART_fromLTC_E3(t,:) = Transitions(Params.E3,Params.E6,:, odeCounter);
    
    % Switch ART regimens 
    
    % LAI ART from ANV
            
    Results.ts_SwitchToLAIART_fromANV_C4(t,:) = Transitions(Params.C4,Params.C6,:, odeCounter);
    Results.ts_SwitchToLAIART_fromANV_D4(t,:) = Transitions(Params.D4,Params.D6,:, odeCounter);
    Results.ts_SwitchToLAIART_fromANV_E4(t,:) = Transitions(Params.E4,Params.E6,:, odeCounter);
    
    % LAI ART from oral ART, VLS
            
    Results.ts_SwitchToLAIART_fromVLS_C5(t,:) = Transitions(Params.C5,Params.C6,:, odeCounter);
    Results.ts_SwitchToLAIART_fromVLS_D5(t,:) = Transitions(Params.D5,Params.D6,:, odeCounter);
    Results.ts_SwitchToLAIART_fromVLS_E5(t,:) = Transitions(Params.E5,Params.E6,:, odeCounter);
    
    % oral ART from LAI ART, VLS
            
    Results.ts_SwitchToOralART_fromLAI_C6(t,:) = Transitions(Params.C6,Params.C5,:, odeCounter);
    Results.ts_SwitchToOralART_fromLAI_D6(t,:) = Transitions(Params.D6,Params.D5,:, odeCounter);
    Results.ts_SwitchToOralART_fromLAI_E6(t,:) = Transitions(Params.E6,Params.E5,:, odeCounter);
    ...
    % Initiate PrEP
        ...
        % starting PrEP
            ...
            Results.ts_StartPrEP_A10(t,:) = Transitions(Params.A1,Params.A10,:, odeCounter);
            
            Results.ts_StartPrEP(t,:) = Results.ts_StartPrEP_A7(t,:) + Results.ts_StartPrEP_A8(t,:) + Results.ts_StartPrEP_A9(t,:) + Results.ts_StartPrEP_A10(t,:);
            Results.ts_StartPrEP_Oral(t,:) = Results.ts_StartPrEP_A7(t,:) + Results.ts_StartPrEP_A8(t,:);
            Results.ts_StartPrEP_Inject(t,:) = Results.ts_StartPrEP_A9(t,:) + Results.ts_StartPrEP_A10(t,:);
    end
        
% TRANSITIONS/COUNTS: Deaths and aged out
    for sectionDeaths = 1:1
    % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024.
    % On 22Jul2024 NormDeaths from E1, E2, E3 removed since they weren't relevant.
    ...
    % Normal death
        ...
        Results.ts_numNormDeaths_A10(t,:) = Transitions(Params.A10,Params.Compart_NormDeath,:, odeCounter);
        ...
        % Note: no Acute oral ART, VLS state
        ...
        % Note: no Acute LAI ART, VLS state
        Results.ts_numNormDeaths_C6(t,:) = Transitions(Params.C6,Params.Compart_NormDeath,:, odeCounter);
        Results.ts_numNormDeaths_D6(t,:) = Transitions(Params.D6,Params.Compart_NormDeath,:, odeCounter);
    ...
    % AIDS death
        ...
        Results.ts_numAIDSDeaths_E1(t,:) = Transitions(Params.E1,Params.Compart_AIDSDeath,:, odeCounter);
        Results.ts_numAIDSDeaths_E2(t,:) = Transitions(Params.E2,Params.Compart_AIDSDeath,:, odeCounter);
        Results.ts_numAIDSDeaths_E3(t,:) = Transitions(Params.E3,Params.Compart_AIDSDeath,:, odeCounter);
        Results.ts_numAIDSDeaths_E4(t,:) = Transitions(Params.E4,Params.Compart_AIDSDeath,:, odeCounter);
        Results.ts_numAIDSDeaths_E5(t,:) = Transitions(Params.E5,Params.Compart_AIDSDeath,:, odeCounter);
        Results.ts_numAIDSDeaths_E6(t,:) = Transitions(Params.E6,Params.Compart_AIDSDeath,:, odeCounter);
...
% STATE VARIABLES: Distibution along distinct continuum stages
    ...
    % include all PrEP states
        ...
        Results.ts_NumberOnPrEP_Oral_HighAdh(t,:) = Compartments(Params.A7,:,odeCounter);
        Results.ts_NumberOnPrEP_Oral_LowAdh(t,:) = Compartments(Params.A8,:,odeCounter);
        Results.ts_NumberOnPrEP_Oral(t,:) = sum(Compartments([Params.A7,Params.A8],:,odeCounter),1);
        Results.ts_NumberOnPrEP_Inject_HighAdh(t,:) = Compartments(Params.A9,:,odeCounter);
        Results.ts_NumberOnPrEP_Inject_LowAdh(t,:) = Compartments(Params.A10,:,odeCounter);
        Results.ts_NumberOnPrEP_Inject(t,:) = sum(Compartments([Params.A9,Params.A10],:,odeCounter),1);
        ...
        Results.ts_TimeOnPrEP_Oral(t,:) = sum(Compartments([Params.A7,Params.A8],:,odeCounter),1) * tstep;
        Results.ts_TimeOnPrEP_Inject(t,:) = sum(Compartments([Params.A9,Params.A10],:,odeCounter),1) * tstep;
    ...
    % Aware
        ...
        Results.ts_NumberAware(t,:) = sum(Compartments(Comparts_CCStages23456,:,odeCounter));
    ...
    % In Care
        ...
        Results.ts_NumberInCare(t,:) = ...  
            ...
            + sum(Compartments(Comparts_CCStage6,:,odeCounter));
    ...
    % Oral ART, VLS
        Results.ts_NumberOralARTVLS(t,:)=sum(Compartments(Comparts_CCStage5,:,odeCounter));
    % VLS (Oral and LAI ART)
        Results.ts_NumberVLS(t,:)=sum(Compartments(Comparts_CCStage56,:,odeCounter));    
    end
...
% STATE VARIABLES: Distribution along model's continuum (r)
   ...
   for sectionComp = 1:1         
    % Diagnosed but not in care, or affected by ART
        ...
        Results.ts_NumberAIDSUndiag(t,:)=(Compartments(Params.E1,:,odeCounter));
        Results.ts_NumberAIDSCCStage2(t,:)=(Compartments(Params.E2,:,odeCounter));
        Results.ts_NumberAIDSCCStage3(t,:)=(Compartments(Params.E3,:,odeCounter));
        Results.ts_NumberAIDSCCStage4(t,:)=(Compartments(Params.E4,:,odeCounter));
        Results.ts_NumberAIDSVLS(t,:)=(Compartments(Params.E5,:,odeCounter));
        Results.ts_NumberAIDS_LAIARTVLS(t,:)=(Compartments(Params.E6,:,odeCounter));
        
        Results.ts_NumberAIDSAware(t,:)=(Compartments(Params.E2,:,odeCounter))...
                                       +(Compartments(Params.E3,:,odeCounter))...
                                       +(Compartments(Params.E4,:,odeCounter))...
                                       +(Compartments(Params.E5,:,odeCounter))...
                                       +(Compartments(Params.E6,:,odeCounter));
    ...
    % Stages 3-4-5-6
        % In Care or affected by ART
         ...
         Results.ts_NumberCCStages3456(t,:)=sum(Compartments(Comparts_CCStages3456,:,odeCounter)); 
            
    % ANV + VLS 
         % Affected by ART or VLS
            Results.ts_NumberCCStages45(t,:)=sum(Compartments(Comparts_CCStages45,:,odeCounter));
    % LAI ART, VLS
        Results.ts_NumberCCStage6(t,:)=sum(Compartments(Comparts_CCStage6,:,odeCounter));        
...
% STATE VARIABLES: Distribution along disease stages (h)
   for sectionHIV = 1:1
        ...
        % Latent (CD4>350) % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
        Results.ts_NumberLatent(t,:) = sum(Compartments(LatentComparts,:,odeCounter));
...
%         Results.ts_numPosConvChronicTests(t,:) = TTProg.numTSPosConvChronicTests';
    % Positive
        Results.ts_numPosRapidTests_byHIVStage(t,:,:) = TTProg.numTSPosRapidTests_byHIVStage;
        Results.ts_numPosConvTests_byHIVStage(t,:,:) = TTProg.numTSPosConvTests_byHIVStage;
    % Negative
        Results.ts_numNegRapidTests_byHIVStage(t,:,:) = TTProg.numTSNegRapidTests_byHIVStage;
        Results.ts_numNegConvTests_byHIVStage(t,:,:)= TTProg.numTSNegConvTests_byHIVStage;
...
% Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
    ...
    % PrEP
        Results.ts_healthStateCost_A7(t,:) = Compartments(Params.A7,:,odeCounter)*tstep .* ...
            Params.AnnualCostPP_PrEP_Oral_High';
        Results.ts_healthStateCost_A8(t,:) = Compartments(Params.A8,:,odeCounter)*tstep .* ...
            Params.AnnualCostPP_PrEP_Oral_Low';
        Results.ts_healthStateCost_A9(t,:) = Compartments(Params.A9,:,odeCounter)*tstep .* ...
            Params.AnnualCostPP_PrEP_Inject_High';
        Results.ts_healthStateCost_A10(t,:) = Compartments(Params.A10,:,odeCounter)*tstep .* ...
            Params.AnnualCostPP_PrEP_Inject_Low';
        ...
        Results.ts_healthStateCost_PrEP_Inject_Undisc = ...            
            ...
            Results.ts_healthStateCost_A10;
    ...
    % Latent 
        ...
        Results.ts_healthStateCost_C6(t,:) = Compartments(Params.C6,:,odeCounter)*tstep * ... 
            AnnualHIVCostsByCompartment(Params.C6);
    ...
    % Late
        ...
        Results.ts_healthStateCost_D6(t,:) = Compartments(Params.D6,:,odeCounter)*tstep * ... 
            AnnualHIVCostsByCompartment(Params.D6);
    ...
    % AIDS
        ...
        Results.ts_healthStateCost_E6(t,:) = Compartments(Params.E6,:,odeCounter)*tstep * ... 
            AnnualHIVCostsByCompartment(Params.E6);

        Results.ts_TransCost_RemainVLS(t,:) = ...
            max(Results.ts_NumberOralARTVLS(t,:) - ...
                (Results.ts_DropOff_VLSToANV_C5(t,:) ...
                + Results.ts_DropOff_VLSToANV_D5(t,:) ...
                + Results.ts_DropOff_VLSToANV_E5(t,:)),0) * ...
                tstep .* Params.TransitionCostPP_TxAdherenceRemainVLS';
...
% TRANSITIONS/COUNTS: Life years
    ...
    % Calculated as:
        ...
        % Latent
        Results.ts_LifeYears_C(t,:) = sum(Compartments(LatentComparts,:,odeCounter))*tstep; 
        % Late
        Results.ts_LifeYears_D(t,:) = sum(Compartments(LateComparts,:,odeCounter))*tstep; 
        % AIDS
        Results.ts_LifeYears_E(t,:) = sum(Compartments(AIDSComparts,:,odeCounter))*tstep; 
    ...
    if (Year-floor(Year)) == 0 % beginning of each year
        ...
        columnIndex = Year - FirstOutcomeYr + 1;
           ...
           % Other Test and Treat Progression Results
            ...
            Results.ann_costPP_TestNegRapid(columnIndex,:,:) = TTProg.costPP_TestNegRapid; 
            Results.ann_costPP_TestPosRapid(columnIndex,:,:) = TTProg.costPP_TestPosRapid; 
            Results.ann_costPP_TestNegConv(columnIndex,:,:) = TTProg.costPP_TestNegConv; 
            Results.ann_costPP_TestPosConv(columnIndex,:,:) = TTProg.costPP_TestPosConv;
...
%% 7. Reformat Results: Last Run of the Model
    ...
    % 7.i. Calculate totals from time step outcomes
      ...
      % DROP OUT
            ...
            % [LAI ART, VLS] -> [LTC]
            Results.ts_TotalDropOff_LAIARTToLTC = ...
                + Results.ts_DropOff_LAIARTToLTC_C6 ...
                + Results.ts_DropOff_LAIARTToLTC_D6 ...
                + Results.ts_DropOff_LAIARTToLTC_E6;  
     ...
     % BECOME VLS
        ...
        % From ANV - edited by LX to include row 6
            Results.ts_BecomeVLSFromANV = ...
                + Results.ts_BecomeVLS_C4 ...
                + Results.ts_BecomeVLS_D4 ...
                + Results.ts_BecomeVLS_E4;

            Results.ts_TotalSwitchToLAIART_fromANV = ...
                + Results.ts_SwitchToLAIART_fromANV_C4 ...
                + Results.ts_SwitchToLAIART_fromANV_D4 ...
                + Results.ts_SwitchToLAIART_fromANV_E4;
            
         % LAI ART, VLS
            Results.ts_TotalStartLAIART_fromLTC = ...
                + Results.ts_StartLAIART_fromLTC_B3 ...
                + Results.ts_StartLAIART_fromLTC_C3 ...
                + Results.ts_StartLAIART_fromLTC_D3 ...
                + Results.ts_StartLAIART_fromLTC_E3;

         % Switch from Oral ART VLS to LAI ART VLS
            Results.ts_TotalSwitchToLAIART_fromVLS = ...
                + Results.ts_SwitchToLAIART_fromVLS_C5 ...
                + Results.ts_SwitchToLAIART_fromVLS_D5 ...
                + Results.ts_SwitchToLAIART_fromVLS_E5;

         % Switch from LAI ART VLS to Oral ART VLS
            Results.ts_TotalSwitchToOralART_fromLAI = ...
                + Results.ts_SwitchToOralART_fromLAI_C6 ...
                + Results.ts_SwitchToOralART_fromLAI_D6 ...
                + Results.ts_SwitchToOralART_fromLAI_E6;
     ...
     % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
        ...
        % Normal deaths for PLWH not on ART, by HIV stage
            ...
            Results.ts_numNormDeathsLatentNoART = ...
        ...
        % Total normal deaths for PLWH on ART or VLS
           ...
           Results.ts_numDeathsLAIART_VLS = ...
               + Results.ts_numNormDeaths_C6 ...
               + Results.ts_numNormDeaths_D6;
           
            Results.ts_numAIDSDeathsLAIART = ...
               + Results.ts_numAIDSDeaths_E6;

            Results.ts_numAIDSDeathsVLS = ...
               + Results.ts_numAIDSDeaths_E5;
            ...
            Results.ts_numAIDSDeathsCCStage4 = ...
               + Results.ts_numAIDSDeaths_E4;
           
            Results.ts_numDeathsCCStage2 = ...
               + Results.ts_numNormDeaths_B2 ...
               + Results.ts_numNormDeaths_C2 ...
               + Results.ts_numNormDeaths_D2 ...
               + Results.ts_numAIDSDeaths_E2;
...
%                     DiscRates_Infs(i,1)= 1/((1+Params.alloc_discRateNewInfections)^(YrsFromDollarYear));
                ...
                % HIV-
                Results.ts_discQALYs_A = Results.ts_LifeYears_A.*(DiscRates_QALYs*ones(1,numStrats)) * Params.hiv_utility_A;
                % Acute
                Results.ts_discQALYs_B = Results.ts_LifeYears_B.*(DiscRates_QALYs*ones(1,numStrats)) * Params.hiv_utility_B;
                % Latent
                Results.ts_discQALYs_C = Results.ts_LifeYears_C.*(DiscRates_QALYs*ones(1,numStrats)) * Params.hiv_utility_C;
                % Late
                Results.ts_discQALYs_D = Results.ts_LifeYears_D.*(DiscRates_QALYs*ones(1,numStrats)) * Params.hiv_utility_D;
                % AIDS
                Results.ts_discQALYs_E = Results.ts_LifeYears_E.*(DiscRates_QALYs*ones(1,numStrats)) * Params.hiv_utility_E;

                % Total QALYs by TStep
                Results.ts_discQALYs = Results.ts_discQALYs_A + ...
                    Results.ts_discQALYs_B + Results.ts_discQALYs_C + ...
                    Results.ts_discQALYs_D + Results.ts_discQALYs_E;
                ...
                % Total QALYs
                    % [1xStrats]
                Results.total_discQALYs_A = sum(Results.ts_discQALYs_A);
                Results.total_discQALYs_B = sum(Results.ts_discQALYs_B);
                Results.total_discQALYs_C = sum(Results.ts_discQALYs_C);
                Results.total_discQALYs_D = sum(Results.ts_discQALYs_D);
                Results.total_discQALYs_E = sum(Results.ts_discQALYs_E);

                
                % Overall QALYs 
                    % [1xStrats]
                Results.total_discQALYs_byCohort = Results.total_discQALYs_A + ...
                    Results.total_discQALYs_B + Results.total_discQALYs_C + ...
                    Results.total_discQALYs_D + Results.total_discQALYs_E;
                
                
                % Total QALYs [1x1]
                Results.total_discQALYs = sum(Results.total_discQALYs_byCohort);
            ...
            % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
                    ...
                    Results.ts_healthStateCost_A10 = Results.ts_healthStateCost_A10 .* (DiscRates_Costs * ones(1,numStrats));
                    
                    Results.ts_healthStateCost_PrEP_Oral = Results.ts_healthStateCost_A7 + Results.ts_healthStateCost_A8;
                    Results.ts_healthStateCost_PrEP_Inject = Results.ts_healthStateCost_A9 + Results.ts_healthStateCost_A10;
                    
                    Results.ts_healthStateCost_PrEP = Results.ts_healthStateCost_A7 + Results.ts_healthStateCost_A8 + Results.ts_healthStateCost_A9 + Results.ts_healthStateCost_A10;
                    ...
                    Results.ts_healthStateCost_C6 = Results.ts_healthStateCost_C6 .* (DiscRates_Costs * ones(1,numStrats));
                    ...
                    Results.ts_healthStateCost_D6 = Results.ts_healthStateCost_D6 .* (DiscRates_Costs * ones(1,numStrats));
                    ...
                    Results.ts_healthStateCost_E6 = Results.ts_healthStateCost_E6 .* (DiscRates_Costs * ones(1,numStrats));

                    % Collect cost of linkage to care after diagnosis by
                    % timestep
                    % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
                    Results.ts_TransCost_LTCAfter_Undisc = ...
                          Results.ts_LinkToCare_B2.* Params.TransitionCostPP_LTCafterDiag(:,1)' ...
                        + Results.ts_LinkToCare_C2.* Params.TransitionCostPP_LTCafterDiag(:,2)' ...
                        + Results.ts_LinkToCare_D2.* Params.TransitionCostPP_LTCafterDiag(:,3)' ...
                        + Results.ts_LinkToCare_E2.* Params.TransitionCostPP_LTCafterDiag(:,4)';
                    
                    % Collect cost of ART initiation by timestep
                    Results.ts_TransCost_ARTInitiation_Undisc = ...
                          (Results.ts_StartARTNotVLS_B3 + Results.ts_BecomeVLS_B3).* Params.TransitionCostPP_ARTInitiation(:,1)' ...
                        + (Results.ts_StartARTNotVLS_C3 + Results.ts_BecomeVLS_C3).* Params.TransitionCostPP_ARTInitiation(:,2)' ...
                        + (Results.ts_StartARTNotVLS_D3 + Results.ts_BecomeVLS_D3).* Params.TransitionCostPP_ARTInitiation(:,3)' ...
                        + (Results.ts_StartARTNotVLS_E3 + Results.ts_BecomeVLS_E3).* Params.TransitionCostPP_ARTInitiation(:,4)';
    ...
    % 7.iii. Calculate state variable outcomes annually
        ...
        finalVariable3(numYears,Params.numStrats,Params.numTestEligStates) = 0;
        ...
        % Set up the initial outputs
                   switch u
                        case 2 
                            initialVariable = Results.ts_NumberCCStages3456;
                        case 3 
                        ...
                        case 11 % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
                            initialVariable = Results.ts_NumberLatent;
                        case 12 % Repeated outcome to avoid error
                            initialVariable = Results.ts_NumberLatent;
                        case 13
                       ...
                       case 33
                        ...
                        case 40
                            initialVariable = Results.ts_NumberAIDS_LAIARTVLS;
                        case 41
                            initialVariable = Results.ts_NumberCCStage6;
                        case 42    
                            initialVariable = Results.ts_NumberOralARTVLS;
                    end 
                    ...
                    switch u
                        case 2
                            Results.ann_NumberCCStages3456 = finalVariable;
                        case 3
                        ...
                        case 11 % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
                            Results.ann_NumberLatent = finalVariable;
                        case 12 % Repeated outcome to avoid error
                             Results.ann_NumberLatent = finalVariable;
                        case 13    
                       ...
                       case 27
                        ...
                        case 40
                            Results.ann_NumberAIDS_LAIARTVLS = finalVariable;
                        case 41
                            Results.ann_NumberCCStage6 = finalVariable;
                        case 42
                            Results.ann_NumberOralARTVLS = finalVariable;    
                    end                                   
    ...
    % 7.iv. Calculate transition/count outcomes annually
        for sectionTransition = 1:1
            ...
            if Params.CollectInfbySource == 1
                ...
                Results.ann_NewInfectionsbySource_Race(Params.numRace,Params.numRace,numYears) = 0;
                ann_NewInfectionsbySource_Race(Params.numStrats,Params.numStrats,numYears) = 0;
            end
            ...
            for u = 22:117 
                ...
                switch u
                    ...
                    case 37
                        initialVariable = Results.ts_discQALYs;
                    case 38
                        initialVariable = Results.ts_LifeYears;
                    case 39
                        initialVariable = Results.ts_discQALYs_A;
                    case 40
                        initialVariable = Results.ts_discQALYs_B;
                    case 41
                        initialVariable = Results.ts_discQALYs_C;
                    case 42
                        initialVariable = Results.ts_discQALYs_D;
                    case 43
                        initialVariable = Results.ts_discQALYs_E;
                    case 44
%                         initialVariable = Results.ts_discQALYs_F;
                    case 45
...
%                         initialVariable = Results.ts_LifeYears_F;
                    case 51
                        initialVariable = Results.ts_numPosRapidTests_byHIVStage;
                    case 52
                        initialVariable = Results.ts_numPosConvTests_byHIVStage;
                    case 53
%                         initialVariable = Results.ts_numPosRapidChronicTests;
                    case 54
%                         initialVariable = Results.ts_numPosConvChronicTests;
                    case 55
                        initialVariable = Results.ts_numNegRapidTests_byHIVStage;
                    case 56
                        initialVariable = Results.ts_numNegConvTests_byHIVStage;
                    case 57
                    ...
                    case 85
                         initialVariable = Results.ts_TransCost_LTCAfter_Undisc;
                    case 86
                         initialVariable = Results.ts_TransCost_ARTInitiation_Undisc;
                    case 87    
                    ...
                    case 111
                        initialVariable = Results.ts_TotalDropOff_LAIARTToLTC;
                    case 112
                        initialVariable = Results.ts_TotalStartLAIART_fromLTC;
                    case 113
                        initialVariable = Results.ts_TotalSwitchToLAIART_fromANV;
                    case 114
                        initialVariable = Results.ts_TotalSwitchToLAIART_fromVLS;
                    case 115
                        initialVariable = Results.ts_TotalSwitchToOralART_fromLAI;
                    case 116  
                        initialVariable = Results.ts_numDeathsLAIART_VLS;
                    case 117  
                        initialVariable = Results.ts_numAIDSDeathsLAIART;    		                           
                end
                ...
                if Params.SolveCont == 1 % continuous
                    ...
                    if ndims(initialVariable) == 2
                        finalVariable(yearCount,:) = sum(initialVariable(1+stepsPerYear...
                            *(yearCount-1) : stepsPerYear*yearCount, :));       
                    elseif ndims(initialVariable) == 3
                        finalVariable3(yearCount,:,:) = sum(initialVariable(1+stepsPerYear...
                            *(yearCount-1) : stepsPerYear*yearCount, :,:));       
                    end
                end
                switch u
                    ...
                    case 37
                        Results.ann_discQALYs = finalVariable;
                    case 38
                        Results.ann_LifeYears = finalVariable;
                    case 39
                        Results.ann_discQALYs_A = finalVariable;
                    case 40
                        Results.ann_discQALYs_B = finalVariable;
                    case 41
                        Results.ann_discQALYs_C = finalVariable;
                    case 42
                        Results.ann_discQALYs_D = finalVariable;
                    case 43
                        Results.ann_discQALYs_E = finalVariable;
                    case 44
%                         Results.ann_discQALYs_F = finalVariable;
                    case 45
...
%                         Results.ann_LifeYears_F = finalVariable;
                    case 51
                        Results.ann_numPosTests_Rapid_byHIVStage = finalVariable3;
                    case 52
                        Results.ann_numPosTests_Conv_byHIVStage = finalVariable3;
%                     case 53
%                         Results.ann_numPosRapidChronicTests = finalVariable;
%                     case 54
%                         Results.ann_numPosConvChronicTests = finalVariable;
                    case 55
                         Results.ann_numNegTests_Rapid_byHIVStage = finalVariable3;
                    case 56
                        Results.ann_numNegTests_Conv_byHIVStage = finalVariable3;
                    case 57
                    ...
                    case 85
                         Results.ann_TransCost_LTCAfter_Undisc = finalVariable .* AllocPopsTargetedIndicator';
                    case 86
                         Results.ann_TransCost_ARTInitiation_Undisc = finalVariable .* AllocPopsTargetedIndicator';
                    case 87
                    ...
                    case 111
                        Results.ann_DropOff_LAIARTToLTC = finalVariable; 
                    case 112
                        Results.ann_StartLAIART_fromLTC = finalVariable;
                    case 113
                        Results.ann_SwitchToLAIART_fromANV = finalVariable;
                    case 114
                        Results.ann_SwitchToLAIART_fromVLS = finalVariable;
                    case 115
                        Results.ann_SwitchToOralART_fromLAI = finalVariable;
                    case 116  
                        Results.ann_numDeathsLAIART_VLS = finalVariable;
                    case 117  
                        Results.ann_numAIDSDeathsLAIART = finalVariable;    
                end
                    ...
                    if Params.CollectInfbySource == 1
                        ...
                        ann_NewInfectionsbySource_Race = ann_NewInfectionsbySource * Params.raceIndicator;
                        Results.ann_NewInfectionsbySource_Race(:,:,yearCount) = (ann_NewInfectionsbySource_Race' * Params.raceIndicator)';                   
                    end
            ...
            % StratsxStratsxnumtsteps, it gives you trouble viewing outcomes
            % after the model run)
    ...
    % 7.v. Calculate Costs
        ...
        % Pre-allocate
        ann_costPosRapidTests_Undisc(numYears,Params.numStrats) = 0;
        ann_costPosConvTests_Undisc(numYears,Params.numStrats) = 0;
        ann_costNegRapidTests_Undisc(numYears,Params.numStrats) = 0;
        ann_costNegConvTests_Undisc(numYears,Params.numStrats) = 0;
...
%         costPosConvChronicTests(numYears,Params.numStrats) = 0;
        ...
        for sectionCosts = 1:1
            ...
            for sectionTransitionCosts = 1:1
                   ...
                   % Undiscounted
                    ...
                    Results.ann_TransCost_LTCFirst_Undisc = ...
                        Results.ann_TotalLinkToCareFirst .* Params.TransitionCostPP_ProbLTCatDiag';
                    %Results.ann_TransCost_LTCAfter_Undisc = calculated earlier in code since cost PP varies by stage ...                       
                    %Results.ann_TransCost_ARTInitiation_Undisc = calculated earlier in code since cost PP varies by stage ...                       
                    Results.ann_TransCost_BecomeVLSfromANV_Undisc = ...
                        Results.ann_BecomeVLSFromANV .* Params.TransitionCostPP_TxAdherenceBecomeVLS';                   
                    %Results.ann_TransCost_RemainVLS_Undisc = used to be calculated
                    %earlier in code
                    Results.ann_TransCost_RemainVLS_Undisc = ...
                        Results.ann_NumberOralARTVLS .* ...
                        (1- RateToProb(Results.ann_TotalDropOff_VLSToANV ./ max(Results.ann_NumberOralARTVLS,1) )) ...
                        .* Params.TransitionCostPP_TxAdherenceRemainVLS';
                   ...
                   % Undiscounted - YMSM only      
                    ...
                    Results.ann_TransCost_LTCFirst_YMSM_Undisc = ...
                        Results.ann_TotalLinkToCareFirst .* Params.TransitionCostPP_ProbLTCatDiag' .* Params.YoungMSMIndicator';
                    Results.ann_TransCost_LTCAfter_YMSM_Undisc = ...
                        Results.ann_TransCost_LTCAfter_Undisc .* Params.YoungMSMIndicator';
                    Results.ann_TransCost_ARTInitiation_YMSM_Undisc = ...
                        Results.ann_TransCost_ARTInitiation_Undisc .* Params.YoungMSMIndicator';
                    Results.ann_TransCost_BecomeVLSfromANV_YMSM_Undisc = ...
                        Results.ann_BecomeVLSFromANV .* Params.TransitionCostPP_TxAdherenceBecomeVLS' .* Params.YoungMSMIndicator'; 
                   ...
                   % Discounted
                    ...
                    Results.ann_TransCost_LTCFirst_Disc = ...
                        Results.ann_TotalLinkToCareFirst .* Params.TransitionCostPP_ProbLTCatDiag' .* (ann_DiscRates_Costs * ones(1,numStrats));
                    Results.ann_TransCost_LTCAfter_Disc = ...
                        Results.ann_TransCost_LTCAfter_Undisc .* (ann_DiscRates_Costs * ones(1,numStrats));
                    Results.ann_TransCost_ARTInitiation_Disc = ...
                        Results.ann_TransCost_ARTInitiation_Undisc  .* (ann_DiscRates_Costs * ones(1,numStrats));
                    Results.ann_TransCost_BecomeVLSfromANV_Disc = ...
                        Results.ann_BecomeVLSFromANV .* Params.TransitionCostPP_TxAdherenceBecomeVLS' .* (ann_DiscRates_Costs * ones(1,numStrats));
                    Results.ann_TransCost_RemainVLS_Disc = ...
                        Results.ann_NumberOralARTVLS .* ...
                        ((1- RateToProb(Results.ann_TotalDropOff_VLSToANV ./ max(Results.ann_NumberOralARTVLS,1) )) ...
                        .* Params.TransitionCostPP_TxAdherenceRemainVLS') .* (ann_DiscRates_Costs * ones(1,numStrats));                    
            ...
            for sectionIntnCosts = 1:1
                    ...
                    % applicable
                        ...
                        % * [NAT Cost] )
                         ...
                         Results.ann_numPosTests = ...
                             squeeze(sum(Results.ann_numPosTests_Rapid_byHIVStage + ...
                             Results.ann_numPosTests_Conv_byHIVStage,3));
                            % Negative tests
                         Results.ann_numNegTests = ...
                             squeeze(sum(Results.ann_numNegTests_Rapid_byHIVStage + ...
                             Results.ann_numNegTests_Conv_byHIVStage,3));
                         ...
                         Results.ann_numTotalTests = ...
                            ...
                            % added by KH on 24Jan2024  
                            costPP_TestPosRapid(1:numYears, 1:numStrats, 1:Params.numTestEligStates)=0;
                            costPP_TestPosConv(1:numYears, 1:numStrats, 1:Params.numTestEligStates)=0;
                            costPP_TestNegRapid(1:numYears, 1:numStrats, 1:Params.numTestEligStates)=0;
                            costPP_TestNegConv(1:numYears, 1:numStrats, 1:Params.numTestEligStates)=0;
                            ...
                            for TestEligStateNum = 1:Params.numTestEligStates
                                costPP_TestNegRapid_thisState = Results.ann_costPP_TestNegRapid(:,:,TestEligStateNum);
                                costPP_TestPosRapid_thisState = Results.ann_costPP_TestPosRapid(:,:,TestEligStateNum);
                                costPP_TestNegConv_thisState = Results.ann_costPP_TestNegConv(:,:,TestEligStateNum);
                                costPP_TestPosConv_thisState = Results.ann_costPP_TestPosConv(:,:,TestEligStateNum);
                                if TestEligStateNum == 2 % Acute
                                    TestSens_Confirm_thisState = TestSens_Confirm_Acute;
                                else
                                    TestSens_Confirm_thisState = TestSens_Confirm_Chronic;
                                end
                                switch TestEligStateNum
                                    case 1 % Cost per uninfected person tested (apply to numUninf that are tested)
                                        costPP_TestNegRapid(:,:,TestEligStateNum) = ...
                                            costPP_TestNegRapid_thisState + (ones(numYears,1) * Params.costPP_TestOutreach); 
                                        costPP_TestNegConv(:,:,TestEligStateNum)= ...
                                            costPP_TestNegConv_thisState + (ones(numYears,1) * Params.costPP_TestOutreach);
                                    otherwise % Cost per unaware PWH tested 
                                        costPP_TestPosRapid(:,:,TestEligStateNum) = ...
                                            (1 - TestSens_Confirm_thisState) .*  ...
                                                (costPP_TestPosRapid_thisState + (ones(numYears,1) * Params.costPP_TestOutreach) + Params.costPP_NATTest ) + ...
                                            TestSens_Confirm_thisState .*  ...
                                                (costPP_TestPosRapid_thisState + (ones(numYears,1) * Params.costPP_TestOutreach) );
                                        costPP_TestPosConv(:,:,TestEligStateNum) = ...
                                            (1 - TestSens_Confirm_thisState) .* ...
                                                (costPP_TestPosConv_thisState + (ones(numYears,1) * Params.costPP_TestOutreach) + Params.costPP_NATTest) + ...
                                            TestSens_Confirm_thisState .* ...
                                                (costPP_TestPosConv_thisState + (ones(numYears,1) * Params.costPP_TestOutreach));
                                        costPP_TestNegRapid(:,:,TestEligStateNum) = ...
                                                (costPP_TestNegRapid_thisState + (ones(numYears,1) * Params.costPP_TestOutreach));
                                        costPP_TestNegConv(:,:,TestEligStateNum) = ...
                                                (costPP_TestNegConv_thisState + (ones(numYears,1) * Params.costPP_TestOutreach));
                    ...
                    % Calculate undiscounted total costs (added by KH on 26Jan2024)        
                    for yearCount = 1:numYears
                        ann_costPosRapidTests_Undisc(yearCount,:) = sum(Results.ann_numPosTests_Rapid_byHIVStage(yearCount,:,:) .* costPP_TestPosRapid(yearCount,:,:),3);
                        ann_costPosConvTests_Undisc(yearCount,:) = sum(Results.ann_numPosTests_Conv_byHIVStage(yearCount,:,:) .* costPP_TestPosConv(yearCount,:,:),3);
                        ann_costNegRapidTests_Undisc(yearCount,:) = sum(Results.ann_numNegTests_Rapid_byHIVStage(yearCount,:,:) .* costPP_TestNegRapid(yearCount,:,:),3);
                        ann_costNegConvTests_Undisc(yearCount,:) = sum(Results.ann_numNegTests_Conv_byHIVStage(yearCount,:,:) .* costPP_TestNegConv(yearCount,:,:),3);
                    end

                    ann_costNegTests_Undisc = ...
                        ann_costNegRapidTests_Undisc + ann_costNegConvTests_Undisc;  
                    ann_costPosTests_Undisc = ...
                        ann_costPosRapidTests_Undisc + ann_costPosConvTests_Undisc;

                    Results.ann_costPosTests_Disc = ...
                        ann_costPosTests_Undisc .* (ann_DiscRates_Costs*ones(1,numStrats));
                    Results.ann_costNegTests_Disc = ...
                        ann_costNegTests_Undisc .* (ann_DiscRates_Costs*ones(1,numStrats));
                                                                 
                   % Pull summary results (Undiscounted)
                    ann_costTotalTesting_Undisc = ...
                        ann_costPosTests_Undisc + ann_costNegTests_Undisc;
                    
                    % Pull summary results
                    Results.ann_costTotalTesting_Disc = ...
                        Results.ann_costPosTests_Disc + Results.ann_costNegTests_Disc;
                ...
                Results.ann_TransCost_CostTestAndNotify_YMSM_Undisc = ...
                     (ann_totalCostNotify_Undisc + ... 
                     ann_costTotalTesting_Undisc) .* Params.YoungMSMIndicator';
                ...
                Results.ann_SEPCost_B_Undisc = Results.ann_NumServedbySEP_B * Params.TransitionCostPP_SEP_3x1(1,1);
                Results.ann_SEPCost_H_Undisc = Results.ann_NumServedbySEP_H * Params.TransitionCostPP_SEP_3x1(2,1);
                Results.ann_SEPCost_O_Undisc = Results.ann_NumServedbySEP_O * Params.TransitionCostPP_SEP_3x1(3,1);
                ...
                Results.ann_SEPCost_Disc = Results.ann_SEPCost_B_Undisc + Results.ann_SEPCost_H_Disc + Results.ann_SEPCost_O_Disc;
    ...
    % New infections and continuum of care by various subpopulations
        ...
        Results.ann_discQALYs_byTransGp = Results.ann_discQALYs * Params.popIndicator;
     ...
     % CONTINUUM OF CARE BY RACE
            ...
            % INCLUSIVE CONTINUUM, BY RACE/ETH
                ...
                % Number dropping from VLS to ANV
                Results.ann_TotalDropOff_VLSToANV_Blk(yearCount,:) = ...
                    Results.ann_TotalDropOff_VLSToANV(yearCount,:)' .*Params.raceIndicator(:,Params.race_B);
                Results.ann_TotalDropOff_VLSToANV_Hisp(yearCount,:) = ...
                    Results.ann_TotalDropOff_VLSToANV(yearCount,:)' .*Params.raceIndicator(:,Params.race_H);
                Results.ann_TotalDropOff_VLSToANV_Oth(yearCount,:) = ...
                    Results.ann_TotalDropOff_VLSToANV(yearCount,:)' .*Params.raceIndicator(:,Params.race_O);
        ...
        % CONTINUUM BY MODEL'S CC STAGES, BY RACE/ETH
            ...
            % LAI ART, VLS    
            Results.ann_NumberCCStage6_Blk(yearCount,:) = ...
                Results.ann_NumberCCStage6(yearCount,:)' .* Params.raceIndicator(:,Params.race_B);
            Results.ann_NumberCCStage6_Hisp(yearCount,:) = ...
                Results.ann_NumberCCStage6(yearCount,:)' .* Params.raceIndicator(:,Params.race_H);
            Results.ann_NumberCCStage6_Oth(yearCount,:) = ...
                Results.ann_NumberCCStage6(yearCount,:)' .* Params.raceIndicator(:,Params.race_O);
        ...
        for testFreqAnalysis = 1:1
             for u = 1:5
                ...
                switch u
                    ...
                    case 3
                        Results.ann_discQALYs_HighRiskHETs = HighRiskOutput;
                        Results.ann_discQALYs_LowRiskHETs = LowRiskOutput;
                    case 4
            ...
            Results.ann_discQALYs_HET = ...
                  Results.ann_discQALYs_HighRiskHETs ...
                + Results.ann_discQALYs_LowRiskHETs;
            ...
            if and(FirstOutcomeYr < Params.tt_periodTwoStartYear,LastOutcomeYr >= Params.tt_periodTwoStartYear - 1)
                ...
                % Updated by KH to collapse CD4350-500 and CD4>500 on 16Jun2024
                % Updated by LX to include row 6
                ...
                Results.DistCompartsLastYrPeriod1(1:6,2) = DistCompartsLastYrPeriod1_store2(4:9,1);
                Results.DistCompartsLastYrPeriod1(1:6,3) = DistCompartsLastYrPeriod1_store2(10:15,1);
                Results.DistCompartsLastYrPeriod1(1:6,4) = DistCompartsLastYrPeriod1_store2(16:21,1);
            ...
            if and(and(FirstOutcomeYr < Params.tt_periodThreeStartYear, ...
                ...
                Results.DistCompartsLastYrPeriod2(1:6,2) = DistCompartsLastYrPeriod2_store2(4:9,1);
                Results.DistCompartsLastYrPeriod2(1:6,3) = DistCompartsLastYrPeriod2_store2(10:15,1);
                Results.DistCompartsLastYrPeriod2(1:6,4) = DistCompartsLastYrPeriod2_store2(16:21,1);
            ...
            if and(and(FirstOutcomeYr < Params.tt_periodFourStartYear, ...
                ...
                Results.DistCompartsLastYrPeriod3(1:6,2) = DistCompartsLastYrPeriod3_store2(4:9,1);
                Results.DistCompartsLastYrPeriod3(1:6,3) = DistCompartsLastYrPeriod3_store2(10:15,1);
                Results.DistCompartsLastYrPeriod3(1:6,4) = DistCompartsLastYrPeriod3_store2(16:21,1);
            ...
            if and(and(FirstOutcomeYr < Params.tt_periodFiveStartYear, ...
                ...
                Results.DistCompartsLastYrPeriod4(1:6,2) = DistCompartsLastYrPeriod4_store2(4:9,1);
                Results.DistCompartsLastYrPeriod4(1:6,3) = DistCompartsLastYrPeriod4_store2(10:15,1);
                Results.DistCompartsLastYrPeriod4(1:6,4) = DistCompartsLastYrPeriod4_store2(16:21,1);
                ...
                Results.DistCompartsLastYr(1:6,2) = DistCompartsLastYr_store2(4:9,1);
                Results.DistCompartsLastYr(1:6,3) = DistCompartsLastYr_store2(10:15,1);
                Results.DistCompartsLastYr(1:6,4) = DistCompartsLastYr_store2(16:21,1);
            ...
            for yearCount = 1:numYears
                ...
                % PrEP costs (undiscounted) by risk group
                    ...
                    Results.ann_healthStateCost_PrEP_Undisc_HighRiskIDUs(yearCount,:) = ...
                        ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)';
                %Added by Bates, 12/28/23

                    % PrEP costs (undisc) by risk group, sex, and PrEP type
                    %Oral
                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETM_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETM_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETM_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETF_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETF_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskHETF_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskMSM_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskMSM_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_HighRiskMSM_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_IDU_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_IDU_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Oral_Undisc_IDU_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Oral_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_O)'; 

                    %Inject 
                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETM_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETM_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETM_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETF_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETF_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskHETF_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_HETF)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskMSM_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskMSM_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_HighRiskMSM_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popSexIndicator(:,Params.popSex_MSM)'...
                        .* Params.riskLevelIndicator(:,Params.risk_Casual)'...
                        .* Params.raceIndicator(:,Params.race_O)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_IDU_B(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_B)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_IDU_H(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_H)';

                    Results.ann_healthStateCost_PrEP_Inject_Undisc_IDU_O(yearCount, :) = ...
                        Results.ann_healthStateCost_PrEP_Inject_Undisc(yearCount,:) ...
                        .* Params.popIndicator(:,Params.pop_IDU)' ...
                        .* Params.raceIndicator(:,Params.race_O)';                     
...
%                     sum(Results.ann_NumberOnPrEP,2) ./ max(sum(Results.ann_NumberUninfected,2),0.00000000001);
        ...
        for sectionRAOptimization = 1:1
            ...
            % QALYs    
                ...
                Results.total_discQALYs_byTransGp = sum(Results.ann_discQALYs_byTransGp,1);
                Results.ann_discQALYs_Total = sum(Results.ann_discQALYs,2);
                Results.ann_discQALYs_YMSM = sum(Results.ann_discQALYs_Total .* AllocPopsTargetedIndicator',2);
